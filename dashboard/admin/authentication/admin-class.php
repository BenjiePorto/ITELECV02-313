...
class ADMIN {
    ...
    public function verifyOTP($username, $email, $password, $tokencode, $otp, $csrf_token) {
        ...
        echo "<script>alert('Verification Successful!'); window.location.href = '../../../';</script>";
    }
    ...
    function send_email($email, $message, $subject, $smtp_email, $smtp_password){
        ...
        $mail->setFrom($smtp_email, "Benjie");
...
if (isset($_POST['btn-verify'])) {
    ...
    $adminVerify = new ADMIN();$adminVerify->verifyOTP($username, $email, $password, $tokencode, $otp, $csrf_token);
